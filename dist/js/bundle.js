...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SetTime);

/***/ }),

/***/ "./src/modules/modalAct.js":
/*!*********************************!*\
  !*** ./src/modules/modalAct.js ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (modalOpen);
...
/* harmony import */ var _modules_modalAct__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modalAct */ "./src/modules/modalAct.js");
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_modalAct__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
createCard = data => {
    data.forEach(({img, title, descr, price}) => {
        ...
        elem.innerHTML = `
            ...
            <div class="menu__item-price">
                <div class="menu__item-cost">Цена:</div>
                <div class="menu__item-total"><span>${undefined.price}</span> грн/день</div>
            </div>
        `;
